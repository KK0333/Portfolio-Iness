...
The website presents my profile, skills, academic projects and contact information.

The project is built using **HTML, CSS and JavaScript**, with some layout utilities from **Bootstrap**.

## Hero Section
The hero section is the first part of the website that visitors see.
...
These techniques allow the design to remain flexible and adaptable.

## Use of Bootstrap Utilities
...
Bootstrap simplifies layout management while still allowing custom design through additional CSS.

## JavaScript Interactivity
JavaScript was used to add interactive elements to the website.

These interactions improve user experience by making navigation more dynamic.

Examples include:
- scroll detection
- smooth scrolling
- scroll-to-top button
- small animations when sections appear
